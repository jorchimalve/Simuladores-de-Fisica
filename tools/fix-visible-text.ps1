...
$Pairs = @(
  ...
  @('cinetica', 'cin&eacute;tica'),
  @('cin-tico', 'cin&eacute;tico'),
  @('estatico', 'est&aacute;tico'),
  @('Periodo', 'Per&iacute;odo'),
  @('Periodo', 'Per&iacute;odo'),
  @('Gu-a', 'Gu&iacute;a'),
  @('grafica', 'gr&aacute;fica'),
  @('grafica', 'gr&aacute;fica'),
  @('Mini-grafica', 'Mini-gr&aacute;fica'),
  @('Mini-grafica', 'Mini-gr&aacute;fica'),
  @('-ltimos', '&uacute;ltimos'),
  @('hist-rico', 'hist&oacute;rico'),
  @('oscilacion', 'oscilaci&oacute;n'),
  @('elongacion', 'elongaci&oacute;n'),
  @('instantaneo', 'instant&aacute;neo'),
  @('cuadratico', 'cuadr&aacute;tico'),
